 ...
 */
public class PlotRaseline extends CPlotBaseMe {
	public PlotRaseline() {
	...
	public ActionType GetAction() {
		...
		float[] param = GetRaseLineParams(this.m_marks);
		if (param != null) {
	...
	private float[] GetRaseLineParams(HashMap<Integer, CPlotMarkMe> pList) {
		if (pList.isEmpty()) {
			return null;
		}
